...
def multi_objfun1(bands, BG_op = 5):
    '''
...
if __name__ == '__main__':
    ...
    #################################################
        ...
        figpath     = ('..//figures//Optimization//Quads_'      +  str(Nquads)  + ' Xdim_' 
                                                                +  str(Xdim)    +  ' MshRs_'     + str(MshRs)
                                                                + ' rfnmt_'     +  str(rf_level)
                                                                +'//BG_op'+str(BG_op)+'BG_op2'+str(BG_op2))
        ...
        #################################################################
        fstar_FEM_raw = multi_objfun(np.array(evals_disp_eval), BG_op = BG_op,BG_op2 = BG_op2)
        ...
        #################################################################
        datapath_optimal = datapath[0:10] + '//OptimizedData' +datapath[22::]+  '//BGop_'+str(BG_op)+'BG_op2'+str(BG_op2)
        ...
        for Enrichment_Index in range(12):
            ...
            # ----------------------------------------------
            datapath_enrich = datapath[0:10] + '//EnrichementData' +datapath[22::]+  '//BGop_'+str(BG_op) +'BG_op2'+str(BG_op2) +'//enrich_loop' + str(Enrichment_Index)
            if savedata:
            ...
            for sidx in range(5):
                ...
                # ----------------------------------------------
                target_enrichment   = normalize(multi_objfun(np.array(evals_disp_enrich), BG_op = BG_op,BG_op2 = BG_op2), targ_raw)
